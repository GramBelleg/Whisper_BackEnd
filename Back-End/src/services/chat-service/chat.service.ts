...
export async function saveChatMessage(message: OmitId<ChatMessage>): Promise<number> {
...
export async function editChatMessage(id: number, content: string): Promise<void> {
